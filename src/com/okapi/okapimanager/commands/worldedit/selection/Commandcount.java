...
public class Commandcount extends BaseCommand {

	public Commandcount(OkapiManager instance) {
		super(instance);
	}
	...
	public void Run(Player player, Server server, String[] args){
		if(args.length == 1){
			...
			player.sendMessage(formatMessage("There are " + i + " blocks of type " + mat.toString().toLowerCase() + "!"));
		}
	}
}
